"""
HTTP Extension for adding custom endpoints to the VividMemory API.
...
class HttpExtension(Extension, ABC):
    ...
    Example:
        ```python
        from fastapi import APIRouter
        from vividmemory_api.extensions import HttpExtension
    ...
    Configuration via environment variables:
        VIVIDMEMORY_API_HTTP_EXTENSION=mypackage.ext:MyHttpExtension
