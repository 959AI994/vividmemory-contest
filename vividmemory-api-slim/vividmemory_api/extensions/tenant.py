...
class TenantExtension(Extension, ABC):
    ...
    Built-in implementation:
        vividmemory_api.extensions.builtin.tenant.ApiKeyTenantExtension
    ...
    async def get_allowed_config_fields(self, context: RequestContext, bank_id: str) -> set[str] | None:
        ...
        Returns:
            ...
            Returned fields must be a subset of VividMemoryConfig.get_configurable_fields().
        """
        return None
    ...
    async def provision_bank_tables(self, conn: "asyncpg.Connection", schema: str) -> None:
        ...
        and by the ``vividmemory-admin run-db-migration`` sweep across all
