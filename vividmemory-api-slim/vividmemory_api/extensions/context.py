...
if TYPE_CHECKING:
    from vividmemory_api.engine.interface import MemoryEngineInterface
    from vividmemory_api.webhooks.manager import WebhookManager
...
class ExtensionContext(ABC):
    ...
    Built-in implementation:
        vividmemory_api.extensions.builtin.context.DefaultExtensionContext
...
class DefaultExtensionContext(ExtensionContext):
    ...
    async def run_migration(self, schema: str) -> None:
        ...
        from vividmemory_api.migrations import (
