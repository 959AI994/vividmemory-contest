"""
Unified API module for VividMemory.
...
def create_app(
    ...
    """
    Create and configure the unified VividMemory API application.
    ...
    if mcp_api_enabled:
        try:
            ...
            logger.error("Install with: pip install vividmemory-api[mcp]")
            raise
    ...
    if http_api_enabled:
        ...
        app = FastAPI(title="VividMemory API", version="0.0.7")
