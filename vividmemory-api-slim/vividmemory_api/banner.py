"""
Banner display for VividMemory API startup.
...
def print_banner():
    """Print the VividMemory startup banner."""
    print(LOGO)
    tagline = gradient_text("VividMemory: Agent Memory That Works Like Human Memory")
    print(f"\n  {tagline}\n")
...
def print_startup_info(
    ...
    print(color_start("Starting VividMemory API..."))
    if version:
