...
if TYPE_CHECKING:
    from vividmemory_api.engine.memory_engine import BankLlmHealthInfo, Budget
    from vividmemory_api.engine.response_models import RecallResult, ReflectResult
    from vividmemory_api.engine.search.tags import TagsMatch
