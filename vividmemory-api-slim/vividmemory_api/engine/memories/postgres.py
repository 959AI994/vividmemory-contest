...
This is the behaviour VividMemory has always had, stated as an implementation of
:class:`~vividmemory_api.engine.memories.base.MemoriesExtension` rather than as the
...
:mod:`vividmemory_api.engine.memories.pg`, split by what calls it — curation,
...
:mod:`vividmemory_api.engine.search.retrieval`.
