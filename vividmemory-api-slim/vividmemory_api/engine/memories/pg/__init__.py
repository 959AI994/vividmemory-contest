...
:class:`~vividmemory_api.engine.memories.postgres.PostgresMemories` is a thin class
...
Every function here takes the live connection and VividMemory's ``fq_table``
