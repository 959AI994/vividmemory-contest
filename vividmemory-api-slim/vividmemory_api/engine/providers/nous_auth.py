...
that package is the interactive CLI, not a library VividMemory can depend on. The
...
VividMemory shares ``~/.hermes/auth.json`` with a possibly-running Hermes agent,
