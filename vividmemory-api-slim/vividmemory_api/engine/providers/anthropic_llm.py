...
from vividmemory_api.engine.llm_interface import LLM_TOOL_CHOICE_AUTO, LLMInterface, LLMToolChoice
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            default_headers: Optional custom headers passed as ``default_headers`` to
                ...
                ``VividMemoryConfig`` (env: ``VIVIDMEMORY_API_LLM_DEFAULT_HEADERS``).
