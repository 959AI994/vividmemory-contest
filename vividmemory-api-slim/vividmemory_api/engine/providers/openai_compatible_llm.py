...
from vividmemory_api.engine.bank_attribution import apply_bank_attribution
...
def _ensure_v1_base_url(base_url: str) -> str:
    ...
    so users commonly set ``VIVIDMEMORY_API_LLM_BASE_URL`` to that bare host. The
    ...
    async def call(
        ...
        Args:
            ...
            strict_schema: Use strict json_schema (grammar-enforced) response_format instead of
                ...
                backends (llama.cpp, vLLM). Server-wide via VIVIDMEMORY_API_LLM_STRICT_SCHEMA.
