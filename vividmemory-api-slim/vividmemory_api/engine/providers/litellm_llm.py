...
from vividmemory_api.config import DEFAULT_LLM_TIMEOUT, ENV_LLM_TIMEOUT
from vividmemory_api.engine.llm_interface import (
...
from vividmemory_api.engine.structured_output import strict_json_schema
...
class LiteLLMLLM(LLMInterface):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # ``None`` falls back to VIVIDMEMORY_API_LLM_TIMEOUT, then DEFAULT_LLM_TIMEOUT — never None,
        ...
        # Sourced from llm_extra_body (env: VIVIDMEMORY_API_LLM_EXTRA_BODY).
        ...
        # wiring. Sourced from llm_default_headers (env: VIVIDMEMORY_API_LLM_DEFAULT_HEADERS).
    ...
    # VividMemory's defaults (e.g. retain_max_completion_tokens=64000) target
