...
A single periodic loop that drives all of VividMemory's recurring housekeeping
...
from ..config import VividMemoryConfig, get_config
...
class MaintenanceLoop:
    ...
    async def _run_retention(self, cfg: VividMemoryConfig) -> None:
    ...
    async def _run_operation_cleanup(self, cfg: VividMemoryConfig) -> None:
