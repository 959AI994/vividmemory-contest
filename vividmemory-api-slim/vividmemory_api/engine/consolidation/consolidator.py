...
async def _find_related_observations(
    ...
    if is_tracing_enabled():
        recall_span = tracer.start_span("vividmemory.consolidation_recall")
        recall_span.set_attribute("vividmemory.bank_id", bank_id)
        recall_span.set_attribute("vividmemory.query", query[:100])  # Truncate for brevity
        recall_span.set_attribute("vividmemory.fact_type", "observation")
    else:
        recall_span = None
    ...
    for attempt in range(1, max_attempts + 1):
        try:
            call_kwargs: dict[str, Any] = {
                ...
                "scope": "consolidation",
                # Resolved per operation (VIVIDMEMORY_API_LLM_STRICT_SCHEMA_CONSOLIDATION, falling
            ...
            # consolidation JSON) set VIVIDMEMORY_API_CONSOLIDATION_MAX_COMPLETION_TOKENS to fix it.
