...
:class:`~vividmemory_api.config.LLMStrategyConfig`, exposing the same public surface
...
the indexed extras (``VIVIDMEMORY_API_<OP>LLM_<n>_*``). Each member keeps its own
