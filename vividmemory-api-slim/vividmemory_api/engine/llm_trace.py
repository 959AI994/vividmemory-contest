...
Opt-in, fire-and-forget recording of every LLM call VividMemory makes (both
...
controlled by ``VIVIDMEMORY_API_LLM_TRACE_ENABLED``.
...
_trace_ctx: ContextVar[LLMTraceContext | None] = ContextVar("vividmemory_llm_trace_ctx", default=None)
...
_request_ctx: ContextVar[dict[str, Any] | None] = ContextVar("vividmemory_llm_request_ctx", default=None)
...
_call_metadata_ctx: ContextVar[dict[str, Any] | None] = ContextVar("vividmemory_llm_call_metadata_ctx", default=None)
...
_response_usage_ctx: ContextVar[LLMResponseUsage | None] = ContextVar("vividmemory_llm_response_usage_ctx", default=None)
...
class LLMTraceRecorder:
    ...
    :func:`vividmemory_api.tracing.register_span_recorder`. Writes are
