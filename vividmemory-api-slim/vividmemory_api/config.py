"""
Centralized configuration for VividMemory API.
...
def load_dotenv_for_entrypoint() -> None:
    """Load a discovered ``.env`` file for VividMemory's own entry points.

    Importing ``vividmemory_api`` (or anything that pulls it in) must NOT mutate
    ...
    This helper is therefore called explicitly from VividMemory's standalone entry
    points only — the API server (CLI and ``vividmemory_api.server:app``), the
...
class StaticConfigProxy:
    """
    Proxy that wraps VividMemoryConfig and only allows access to static (non-configurable) fields.
    ...
    def __init__(self, config: "VividMemoryConfig"):
        object.__setattr__(self, "_config", config)
        object.__setattr__(self, "_configurable_fields", VividMemoryConfig.get_configurable_fields())
...
def normalize_config_key(key: str) -> str:
    ...
    Examples:
        VIVIDMEMORY_API_LLM_PROVIDER -> llm_provider
        LLM_MODEL -> llm_model
    ...
    """
    if key.startswith("VIVIDMEMORY_API_"):
        key = key[len("VIVIDMEMORY_API_") :]
    return key.lower()
...
def normalize_config_dict(config: dict[str, Any]) -> dict[str, Any]:
    ...
    - Env var format: {"VIVIDMEMORY_API_LLM_PROVIDER": "openai"}
...
ENV_DATABASE_BACKEND = "VIVIDMEMORY_API_DATABASE_BACKEND"
ENV_DATABASE_URL = "VIVIDMEMORY_API_DATABASE_URL"
ENV_READ_DATABASE_URL = "VIVIDMEMORY_API_READ_DATABASE_URL"
ENV_READ_DB_POOL_MIN_SIZE = "VIVIDMEMORY_API_READ_DB_POOL_MIN_SIZE"
ENV_READ_DB_POOL_MAX_SIZE = "VIVIDMEMORY_API_READ_DB_POOL_MAX_SIZE"
ENV_MIGRATION_DATABASE_URL = "VIVIDMEMORY_API_MIGRATION_DATABASE_URL"
ENV_DATABASE_SCHEMA = "VIVIDMEMORY_API_DATABASE_SCHEMA"
ENV_LLM_PROVIDER = "VIVIDMEMORY_API_LLM_PROVIDER"
ENV_LLM_API_KEY = "VIVIDMEMORY_API_LLM_API_KEY"
ENV_LLM_MODEL = "VIVIDMEMORY_API_LLM_MODEL"
ENV_LLM_BASE_URL = "VIVIDMEMORY_API_LLM_BASE_URL"
ENV_LLM_MAX_CONCURRENT = "VIVIDMEMORY_API_LLM_MAX_CONCURRENT"
ENV_LLM_MAX_RETRIES = "VIVIDMEMORY_API_LLM_MAX_RETRIES"
ENV_LLM_INITIAL_BACKOFF = "VIVIDMEMORY_API_LLM_INITIAL_BACKOFF"
ENV_LLM_MAX_BACKOFF = "VIVIDMEMORY_API_LLM_MAX_BACKOFF"
ENV_LLM_TIMEOUT = "VIVIDMEMORY_API_LLM_TIMEOUT"
ENV_LLM_REASONING_EFFORT = "VIVIDMEMORY_API_LLM_REASONING_EFFORT"
ENV_LLM_GROQ_SERVICE_TIER = "VIVIDMEMORY_API_LLM_GROQ_SERVICE_TIER"
ENV_LLM_OPENAI_SERVICE_TIER = "VIVIDMEMORY_API_LLM_OPENAI_SERVICE_TIER"
ENV_LLM_BEDROCK_SERVICE_TIER = "VIVIDMEMORY_API_LLM_BEDROCK_SERVICE_TIER"
ENV_LLM_GEMINI_SERVICE_TIER = "VIVIDMEMORY_API_LLM_GEMINI_SERVICE_TIER"
ENV_LLM_EXTRA_BODY = "VIVIDMEMORY_API_LLM_EXTRA_BODY"
ENV_LLM_DEFAULT_HEADERS = "VIVIDMEMORY_API_LLM_DEFAULT_HEADERS"
...
ENV_LLM_STRICT_SCHEMA = "VIVIDMEMORY_API_LLM_STRICT_SCHEMA"
ENV_LLM_STRICT_SCHEMA_RETAIN = "VIVIDMEMORY_API_LLM_STRICT_SCHEMA_RETAIN"
ENV_LLM_STRICT_SCHEMA_REFLECT = "VIVIDMEMORY_API_LLM_STRICT_SCHEMA_REFLECT"
ENV_LLM_STRICT_SCHEMA_CONSOLIDATION = "VIVIDMEMORY_API_LLM_STRICT_SCHEMA_CONSOLIDATION"
ENV_LLM_SUPPORTS_MAX_ITEMS = "VIVIDMEMORY_API_LLM_SUPPORTS_MAX_ITEMS"
ENV_LLM_SEND_BANK_AS_USER = "VIVIDMEMORY_API_LLM_SEND_BANK_AS_USER"
ENV_LLM_OLLAMA_NUM_CTX = "VIVIDMEMORY_API_LLM_OLLAMA_NUM_CTX"
...
ENV_LLM_TEMPERATURE = "VIVIDMEMORY_API_LLM_TEMPERATURE"
ENV_LLM_TEMPERATURE_VERIFICATION = "VIVIDMEMORY_API_LLM_TEMPERATURE_VERIFICATION"
ENV_LLM_TEMPERATURE_RETAIN = "VIVIDMEMORY_API_LLM_TEMPERATURE_RETAIN"
ENV_LLM_TEMPERATURE_REFLECT = "VIVIDMEMORY_API_LLM_TEMPERATURE_REFLECT"
ENV_LLM_TEMPERATURE_CONSOLIDATION = "VIVIDMEMORY_API_LLM_TEMPERATURE_CONSOLIDATION"

# Multi-LLM strategy. Extra LLMs are configured by index alongside the unindexed
# primary (e.g. VIVIDMEMORY_API_LLM_1_PROVIDER, VIVIDMEMORY_API_LLM_2_PROVIDER, ...),
# and VIVIDMEMORY_API_LLM_STRATEGY (JSON) selects how to route across them — see
# _parse_llm_members / _parse_llm_strategy below. Each operation can override the
# global chain with its own VIVIDMEMORY_API_<OP>_LLM_<n>_* members + _STRATEGY.
ENV_LLM_STRATEGY = "VIVIDMEMORY_API_LLM_STRATEGY"
ENV_RETAIN_LLM_STRATEGY = "VIVIDMEMORY_API_RETAIN_LLM_STRATEGY"
ENV_REFLECT_LLM_STRATEGY = "VIVIDMEMORY_API_REFLECT_LLM_STRATEGY"
ENV_CONSOLIDATION_LLM_STRATEGY = "VIVIDMEMORY_API_CONSOLIDATION_LLM_STRATEGY"
...
ENV_LLM_LITELLMROUTER_CONFIG = "VIVIDMEMORY_API_LLM_LITELLMROUTER_CONFIG"
...
def parse_gemini_service_tier(value: str | None) -> str | None:
    ...
    if tier not in valid_tiers:
        raise ValueError(
            f"Invalid VIVIDMEMORY_API_LLM_GEMINI_SERVICE_TIER: "
...
def _resolve_operation_temperature(operation_env: str, default: float) -> float | None:
    ...
    ``VIVIDMEMORY_API_LLM_TEMPERATURE=none`` drops temperature from every operation
...
ENV_RETAIN_LLM_PROVIDER = "VIVIDMEMORY_API_RETAIN_LLM_PROVIDER"
ENV_RETAIN_LLM_API_KEY = "VIVIDMEMORY_API_RETAIN_LLM_API_KEY"
ENV_RETAIN_LLM_MODEL = "VIVIDMEMORY_API_RETAIN_LLM_MODEL"
ENV_RETAIN_LLM_BASE_URL = "VIVIDMEMORY_API_RETAIN_LLM_BASE_URL"
ENV_RETAIN_LLM_MAX_CONCURRENT = "VIVIDMEMORY_API_RETAIN_LLM_MAX_CONCURRENT"
ENV_RETAIN_LLM_MAX_RETRIES = "VIVIDMEMORY_API_RETAIN_LLM_MAX_RETRIES"
ENV_RETAIN_LLM_INITIAL_BACKOFF = "VIVIDMEMORY_API_RETAIN_LLM_INITIAL_BACKOFF"
ENV_RETAIN_LLM_MAX_BACKOFF = "VIVIDMEMORY_API_RETAIN_LLM_MAX_BACKOFF"
ENV_RETAIN_LLM_TIMEOUT = "VIVIDMEMORY_API_RETAIN_LLM_TIMEOUT"
ENV_RETAIN_LLM_LITELLMROUTER_CONFIG = "VIVIDMEMORY_API_RETAIN_LLM_LITELLMROUTER_CONFIG"
ENV_RETAIN_LLM_REASONING_EFFORT = "VIVIDMEMORY_API_RETAIN_LLM_REASONING_EFFORT"
ENV_RETAIN_LLM_EXTRA_BODY = "VIVIDMEMORY_API_RETAIN_LLM_EXTRA_BODY"
...
ENV_FIREWORKS_ACCOUNT_ID = "VIVIDMEMORY_API_FIREWORKS_ACCOUNT_ID"
ENV_FIREWORKS_BATCH_BASE_URL = "VIVIDMEMORY_API_FIREWORKS_BATCH_BASE_URL"
ENV_FIREWORKS_BATCH_MAX_WAIT_SECONDS = "VIVIDMEMORY_API_FIREWORKS_BATCH_MAX_WAIT_SECONDS"
...
ENV_REFLECT_LLM_PROVIDER = "VIVIDMEMORY_API_REFLECT_LLM_PROVIDER"
ENV_REFLECT_LLM_API_KEY = "VIVIDMEMORY_API_REFLECT_LLM_API_KEY"
ENV_REFLECT_LLM_MODEL = "VIVIDMEMORY_API_REFLECT_LLM_MODEL"
ENV_REFLECT_LLM_BASE_URL = "VIVIDMEMORY_API_REFLECT_LLM_BASE_URL"
ENV_REFLECT_LLM_MAX_CONCURRENT = "VIVIDMEMORY_API_REFLECT_LLM_MAX_CONCURRENT"
ENV_REFLECT_LLM_MAX_RETRIES = "VIVIDMEMORY_API_REFLECT_LLM_MAX_RETRIES"
ENV_REFLECT_LLM_INITIAL_BACKOFF = "VIVIDMEMORY_API_REFLECT_LLM_INITIAL_BACKOFF"
ENV_REFLECT_LLM_MAX_BACKOFF = "VIVIDMEMORY_API_REFLECT_LLM_MAX_BACKOFF"
ENV_REFLECT_LLM_TIMEOUT = "VIVIDMEMORY_API_REFLECT_LLM_TIMEOUT"
ENV_REFLECT_LLM_LITELLMROUTER_CONFIG = "VIVIDMEMORY_API_REFLECT_LLM_LITELLMROUTER_CONFIG"
ENV_REFLECT_LLM_REASONING_EFFORT = "VIVIDMEMORY_API_REFLECT_LLM_REASONING_EFFORT"
ENV_REFLECT_LLM_EXTRA_BODY = "VIVIDMEMORY_API_REFLECT_LLM_EXTRA_BODY"

ENV_CONSOLIDATION_LLM_PROVIDER = "VIVIDMEMORY_API_CONSOLIDATION_LLM_PROVIDER"
ENV_CONSOLIDATION_LLM_API_KEY = "VIVIDMEMORY_API_CONSOLIDATION_LLM_API_KEY"
ENV_CONSOLIDATION_LLM_MODEL = "VIVIDMEMORY_API_CONSOLIDATION_LLM_MODEL"
ENV_CONSOLIDATION_LLM_BASE_URL = "VIVIDMEMORY_API_CONSOLIDATION_LLM_BASE_URL"
ENV_CONSOLIDATION_LLM_MAX_CONCURRENT = "VIVIDMEMORY_API_CONSOLIDATION_LLM_MAX_CONCURRENT"
ENV_CONSOLIDATION_LLM_MAX_RETRIES = "VIVIDMEMORY_API_CONSOLIDATION_LLM_MAX_RETRIES"
ENV_CONSOLIDATION_LLM_INITIAL_BACKOFF = "VIVIDMEMORY_API_CONSOLIDATION_LLM_INITIAL_BACKOFF"
ENV_CONSOLIDATION_LLM_MAX_BACKOFF = "VIVIDMEMORY_API_CONSOLIDATION_LLM_MAX_BACKOFF"
ENV_CONSOLIDATION_LLM_TIMEOUT = "VIVIDMEMORY_API_CONSOLIDATION_LLM_TIMEOUT"
ENV_CONSOLIDATION_LLM_LITELLMROUTER_CONFIG = "VIVIDMEMORY_API_CONSOLIDATION_LLM_LITELLMROUTER_CONFIG"
ENV_CONSOLIDATION_LLM_REASONING_EFFORT = "VIVIDMEMORY_API_CONSOLIDATION_LLM_REASONING_EFFORT"
ENV_CONSOLIDATION_LLM_EXTRA_BODY = "VIVIDMEMORY_API_CONSOLIDATION_LLM_EXTRA_BODY"

ENV_EMBEDDINGS_PROVIDER = "VIVIDMEMORY_API_EMBEDDINGS_PROVIDER"
ENV_EMBEDDINGS_LOCAL_MODEL = "VIVIDMEMORY_API_EMBEDDINGS_LOCAL_MODEL"
ENV_EMBEDDINGS_LOCAL_FORCE_CPU = "VIVIDMEMORY_API_EMBEDDINGS_LOCAL_FORCE_CPU"
ENV_EMBEDDINGS_LOCAL_ALLOW_MPS = "VIVIDMEMORY_API_EMBEDDINGS_LOCAL_ALLOW_MPS"
ENV_EMBEDDINGS_LOCAL_TRUST_REMOTE_CODE = "VIVIDMEMORY_API_EMBEDDINGS_LOCAL_TRUST_REMOTE_CODE"
ENV_EMBEDDINGS_ONNX_MODEL_ID = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_MODEL_ID"
ENV_EMBEDDINGS_ONNX_MODEL_PATH = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_MODEL_PATH"
ENV_EMBEDDINGS_ONNX_TOKENIZER_NAME_OR_PATH = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_TOKENIZER_NAME_OR_PATH"
ENV_EMBEDDINGS_ONNX_FILE = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_FILE"
ENV_EMBEDDINGS_ONNX_DIMENSIONS = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_DIMENSIONS"
ENV_EMBEDDINGS_ONNX_MAX_TOKENS = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_MAX_TOKENS"
ENV_EMBEDDINGS_ONNX_POOLING = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_POOLING"
ENV_EMBEDDINGS_ONNX_NORMALIZE = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_NORMALIZE"
ENV_EMBEDDINGS_ONNX_QUERY_PREFIX = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_QUERY_PREFIX"
ENV_EMBEDDINGS_ONNX_PASSAGE_PREFIX = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_PASSAGE_PREFIX"
ENV_EMBEDDINGS_ONNX_OUTPUT_NAME = "VIVIDMEMORY_API_EMBEDDINGS_ONNX_OUTPUT_NAME"
ENV_EMBEDDINGS_TEI_URL = "VIVIDMEMORY_API_EMBEDDINGS_TEI_URL"
ENV_EMBEDDINGS_OPENAI_API_KEY = "VIVIDMEMORY_API_EMBEDDINGS_OPENAI_API_KEY"
ENV_EMBEDDINGS_OPENAI_MODEL = "VIVIDMEMORY_API_EMBEDDINGS_OPENAI_MODEL"
ENV_EMBEDDINGS_OPENAI_BASE_URL = "VIVIDMEMORY_API_EMBEDDINGS_OPENAI_BASE_URL"
ENV_EMBEDDINGS_OPENAI_BATCH_SIZE = "VIVIDMEMORY_API_EMBEDDINGS_OPENAI_BATCH_SIZE"
ENV_EMBEDDINGS_OPENAI_DIMENSIONS = "VIVIDMEMORY_API_EMBEDDINGS_OPENAI_DIMENSIONS"

# Gemini/Vertex AI embeddings configuration
ENV_EMBEDDINGS_GEMINI_API_KEY = "VIVIDMEMORY_API_EMBEDDINGS_GEMINI_API_KEY"
ENV_EMBEDDINGS_GEMINI_MODEL = "VIVIDMEMORY_API_EMBEDDINGS_GEMINI_MODEL"
ENV_EMBEDDINGS_GEMINI_OUTPUT_DIMENSIONALITY = "VIVIDMEMORY_API_EMBEDDINGS_GEMINI_OUTPUT_DIMENSIONALITY"
ENV_EMBEDDINGS_GEMINI_FORCE_IPV4 = "VIVIDMEMORY_API_EMBEDDINGS_GEMINI_FORCE_IPV4"
ENV_EMBEDDINGS_VERTEXAI_PROJECT_ID = "VIVIDMEMORY_API_EMBEDDINGS_VERTEXAI_PROJECT_ID"
ENV_EMBEDDINGS_VERTEXAI_REGION = "VIVIDMEMORY_API_EMBEDDINGS_VERTEXAI_REGION"
ENV_EMBEDDINGS_VERTEXAI_SERVICE_ACCOUNT_KEY = "VIVIDMEMORY_API_EMBEDDINGS_VERTEXAI_SERVICE_ACCOUNT_KEY"

# Cohere configuration (separate for embeddings and reranker)
ENV_EMBEDDINGS_COHERE_API_KEY = "VIVIDMEMORY_API_EMBEDDINGS_COHERE_API_KEY"
ENV_EMBEDDINGS_COHERE_MODEL = "VIVIDMEMORY_API_EMBEDDINGS_COHERE_MODEL"
ENV_EMBEDDINGS_COHERE_BASE_URL = "VIVIDMEMORY_API_EMBEDDINGS_COHERE_BASE_URL"
ENV_EMBEDDINGS_COHERE_OUTPUT_DIMENSIONS = "VIVIDMEMORY_API_EMBEDDINGS_COHERE_OUTPUT_DIMENSIONS"
ENV_RERANKER_COHERE_API_KEY = "VIVIDMEMORY_API_RERANKER_COHERE_API_KEY"
ENV_RERANKER_COHERE_MODEL = "VIVIDMEMORY_API_RERANKER_COHERE_MODEL"
ENV_RERANKER_COHERE_BASE_URL = "VIVIDMEMORY_API_RERANKER_COHERE_BASE_URL"

# OpenRouter configuration (embeddings and reranker)
ENV_OPENROUTER_API_KEY = "VIVIDMEMORY_API_OPENROUTER_API_KEY"
ENV_EMBEDDINGS_OPENROUTER_API_KEY = "VIVIDMEMORY_API_EMBEDDINGS_OPENROUTER_API_KEY"
ENV_EMBEDDINGS_OPENROUTER_MODEL = "VIVIDMEMORY_API_EMBEDDINGS_OPENROUTER_MODEL"
ENV_RERANKER_OPENROUTER_API_KEY = "VIVIDMEMORY_API_RERANKER_OPENROUTER_API_KEY"
ENV_RERANKER_OPENROUTER_MODEL = "VIVIDMEMORY_API_RERANKER_OPENROUTER_MODEL"
ENV_RERANKER_OPENROUTER_BASE_URL = "VIVIDMEMORY_API_RERANKER_OPENROUTER_BASE_URL"

# Requesty configuration (OpenAI-compatible gateway; embeddings)
ENV_REQUESTY_API_KEY = "VIVIDMEMORY_API_REQUESTY_API_KEY"
ENV_EMBEDDINGS_REQUESTY_API_KEY = "VIVIDMEMORY_API_EMBEDDINGS_REQUESTY_API_KEY"
ENV_EMBEDDINGS_REQUESTY_MODEL = "VIVIDMEMORY_API_EMBEDDINGS_REQUESTY_MODEL"

# ZeroEntropy configuration (embeddings)
ENV_EMBEDDINGS_ZEROENTROPY_API_KEY = "VIVIDMEMORY_API_EMBEDDINGS_ZEROENTROPY_API_KEY"
ENV_EMBEDDINGS_ZEROENTROPY_MODEL = "VIVIDMEMORY_API_EMBEDDINGS_ZEROENTROPY_MODEL"
ENV_EMBEDDINGS_ZEROENTROPY_BASE_URL = "VIVIDMEMORY_API_EMBEDDINGS_ZEROENTROPY_BASE_URL"
ENV_EMBEDDINGS_ZEROENTROPY_DIMENSIONS = "VIVIDMEMORY_API_EMBEDDINGS_ZEROENTROPY_DIMENSIONS"
ENV_EMBEDDINGS_ZEROENTROPY_ENCODING_FORMAT = "VIVIDMEMORY_API_EMBEDDINGS_ZEROENTROPY_ENCODING_FORMAT"
ENV_EMBEDDINGS_ZEROENTROPY_LATENCY = "VIVIDMEMORY_API_EMBEDDINGS_ZEROENTROPY_LATENCY"
ENV_EMBEDDINGS_ZEROENTROPY_BATCH_SIZE = "VIVIDMEMORY_API_EMBEDDINGS_ZEROENTROPY_BATCH_SIZE"

# Deprecated: Legacy shared Cohere API key (for backward compatibility)
ENV_COHERE_API_KEY = "VIVIDMEMORY_API_COHERE_API_KEY"

# LiteLLM configuration (separate for embeddings and reranker)
ENV_EMBEDDINGS_LITELLM_API_BASE = "VIVIDMEMORY_API_EMBEDDINGS_LITELLM_API_BASE"
ENV_EMBEDDINGS_LITELLM_API_KEY = "VIVIDMEMORY_API_EMBEDDINGS_LITELLM_API_KEY"
ENV_EMBEDDINGS_LITELLM_MODEL = "VIVIDMEMORY_API_EMBEDDINGS_LITELLM_MODEL"
ENV_RERANKER_LITELLM_API_BASE = "VIVIDMEMORY_API_RERANKER_LITELLM_API_BASE"
ENV_RERANKER_LITELLM_API_KEY = "VIVIDMEMORY_API_RERANKER_LITELLM_API_KEY"
ENV_RERANKER_LITELLM_MODEL = "VIVIDMEMORY_API_RERANKER_LITELLM_MODEL"
ENV_RERANKER_LITELLM_MAX_TOKENS_PER_DOC = "VIVIDMEMORY_API_RERANKER_LITELLM_MAX_TOKENS_PER_DOC"

# LiteLLM SDK configuration (direct API access, no proxy needed)
ENV_EMBEDDINGS_LITELLM_SDK_API_KEY = "VIVIDMEMORY_API_EMBEDDINGS_LITELLM_SDK_API_KEY"
ENV_EMBEDDINGS_LITELLM_SDK_MODEL = "VIVIDMEMORY_API_EMBEDDINGS_LITELLM_SDK_MODEL"
ENV_EMBEDDINGS_LITELLM_SDK_API_BASE = "VIVIDMEMORY_API_EMBEDDINGS_LITELLM_SDK_API_BASE"
ENV_EMBEDDINGS_LITELLM_SDK_OUTPUT_DIMENSIONS = "VIVIDMEMORY_API_EMBEDDINGS_LITELLM_SDK_OUTPUT_DIMENSIONS"
ENV_EMBEDDINGS_LITELLM_SDK_ENCODING_FORMAT = "VIVIDMEMORY_API_EMBEDDINGS_LITELLM_SDK_ENCODING_FORMAT"
# Provider-agnostic per-input truncation cap (tiktoken cl100k_base tokens).
ENV_EMBEDDINGS_MAX_INPUT_TOKENS = "VIVIDMEMORY_API_EMBEDDINGS_MAX_INPUT_TOKENS"
...
ENV_EMBEDDINGS_LITELLM_SDK_MAX_INPUT_TOKENS = "VIVIDMEMORY_API_EMBEDDINGS_LITELLM_SDK_MAX_INPUT_TOKENS"
ENV_RERANKER_LITELLM_SDK_API_KEY = "VIVIDMEMORY_API_RERANKER_LITELLM_SDK_API_KEY"
ENV_RERANKER_LITELLM_SDK_MODEL = "VIVIDMEMORY_API_RERANKER_LITELLM_SDK_MODEL"
ENV_RERANKER_LITELLM_SDK_API_BASE = "VIVIDMEMORY_API_RERANKER_LITELLM_SDK_API_BASE"

# Deprecated: Legacy shared LiteLLM config (for backward compatibility)
ENV_LITELLM_API_BASE = "VIVIDMEMORY_API_LITELLM_API_BASE"
ENV_LITELLM_API_KEY = "VIVIDMEMORY_API_LITELLM_API_KEY"

ENV_RERANKER_PROVIDER = "VIVIDMEMORY_API_RERANKER_PROVIDER"
ENV_RERANKER_SEND_BANK_AS_HEADER = "VIVIDMEMORY_API_RERANKER_SEND_BANK_AS_HEADER"
ENV_RERANKER_LOCAL_MODEL = "VIVIDMEMORY_API_RERANKER_LOCAL_MODEL"
ENV_RERANKER_LOCAL_FORCE_CPU = "VIVIDMEMORY_API_RERANKER_LOCAL_FORCE_CPU"
ENV_RERANKER_LOCAL_ALLOW_MPS = "VIVIDMEMORY_API_RERANKER_LOCAL_ALLOW_MPS"
ENV_RERANKER_LOCAL_MAX_CONCURRENT = "VIVIDMEMORY_API_RERANKER_LOCAL_MAX_CONCURRENT"
ENV_RERANKER_LOCAL_TRUST_REMOTE_CODE = "VIVIDMEMORY_API_RERANKER_LOCAL_TRUST_REMOTE_CODE"
ENV_RERANKER_LOCAL_FP16 = "VIVIDMEMORY_API_RERANKER_LOCAL_FP16"
ENV_RERANKER_LOCAL_BUCKET_BATCHING = "VIVIDMEMORY_API_RERANKER_LOCAL_BUCKET_BATCHING"
ENV_RERANKER_LOCAL_BATCH_SIZE = "VIVIDMEMORY_API_RERANKER_LOCAL_BATCH_SIZE"
ENV_RERANKER_TEI_URL = "VIVIDMEMORY_API_RERANKER_TEI_URL"
ENV_RERANKER_TEI_BATCH_SIZE = "VIVIDMEMORY_API_RERANKER_TEI_BATCH_SIZE"
ENV_RERANKER_TEI_MAX_CONCURRENT = "VIVIDMEMORY_API_RERANKER_TEI_MAX_CONCURRENT"
ENV_RERANKER_TEI_HTTP_TIMEOUT = "VIVIDMEMORY_API_RERANKER_TEI_HTTP_TIMEOUT"
ENV_RERANKER_COHERE_TIMEOUT = "VIVIDMEMORY_API_RERANKER_COHERE_TIMEOUT"
ENV_RERANKER_OPENROUTER_TIMEOUT = "VIVIDMEMORY_API_RERANKER_OPENROUTER_TIMEOUT"
ENV_RERANKER_ZEROENTROPY_TIMEOUT = "VIVIDMEMORY_API_RERANKER_ZEROENTROPY_TIMEOUT"
ENV_RERANKER_SILICONFLOW_TIMEOUT = "VIVIDMEMORY_API_RERANKER_SILICONFLOW_TIMEOUT"
ENV_RERANKER_ALIBABA_TIMEOUT = "VIVIDMEMORY_API_RERANKER_ALIBABA_TIMEOUT"
ENV_RERANKER_LITELLM_TIMEOUT = "VIVIDMEMORY_API_RERANKER_LITELLM_TIMEOUT"
ENV_RERANKER_LITELLM_SDK_TIMEOUT = "VIVIDMEMORY_API_RERANKER_LITELLM_SDK_TIMEOUT"
ENV_RERANKER_GOOGLE_TIMEOUT = "VIVIDMEMORY_API_RERANKER_GOOGLE_TIMEOUT"
ENV_RERANKER_MAX_CANDIDATES = "VIVIDMEMORY_API_RERANKER_MAX_CANDIDATES"
...
ENV_RERANKER_MAX_CANDIDATES_LOW = "VIVIDMEMORY_API_RERANKER_MAX_CANDIDATES_LOW"
ENV_RERANKER_MAX_CANDIDATES_MID = "VIVIDMEMORY_API_RERANKER_MAX_CANDIDATES_MID"
ENV_RERANKER_MAX_CANDIDATES_HIGH = "VIVIDMEMORY_API_RERANKER_MAX_CANDIDATES_HIGH"
ENV_SEMANTIC_MIN_SIMILARITY = "VIVIDMEMORY_API_SEMANTIC_MIN_SIMILARITY"
ENV_GRAPH_SEED_MIN_SIMILARITY = "VIVIDMEMORY_API_GRAPH_SEED_MIN_SIMILARITY"
ENV_TEMPORAL_SEMANTIC_MIN_SIMILARITY = "VIVIDMEMORY_API_TEMPORAL_SEMANTIC_MIN_SIMILARITY"
ENV_SEMANTIC_LINK_MIN_SIMILARITY = "VIVIDMEMORY_API_SEMANTIC_LINK_MIN_SIMILARITY"
ENV_RERANKER_FLASHRANK_MODEL = "VIVIDMEMORY_API_RERANKER_FLASHRANK_MODEL"
ENV_RERANKER_FLASHRANK_CACHE_DIR = "VIVIDMEMORY_API_RERANKER_FLASHRANK_CACHE_DIR"
ENV_RERANKER_FLASHRANK_CPU_MEM_ARENA = "VIVIDMEMORY_API_RERANKER_FLASHRANK_CPU_MEM_ARENA"

# ZeroEntropy configuration (reranker only)
ENV_RERANKER_ZEROENTROPY_API_KEY = "VIVIDMEMORY_API_RERANKER_ZEROENTROPY_API_KEY"
ENV_RERANKER_ZEROENTROPY_MODEL = "VIVIDMEMORY_API_RERANKER_ZEROENTROPY_MODEL"
ENV_RERANKER_ZEROENTROPY_BASE_URL = "VIVIDMEMORY_API_RERANKER_ZEROENTROPY_BASE_URL"

# SiliconFlow configuration (reranker only; Cohere-compatible /rerank endpoint)
ENV_RERANKER_SILICONFLOW_API_KEY = "VIVIDMEMORY_API_RERANKER_SILICONFLOW_API_KEY"
ENV_RERANKER_SILICONFLOW_MODEL = "VIVIDMEMORY_API_RERANKER_SILICONFLOW_MODEL"
ENV_RERANKER_SILICONFLOW_BASE_URL = "VIVIDMEMORY_API_RERANKER_SILICONFLOW_BASE_URL"

# Alibaba Cloud DashScope configuration (reranker only)
ENV_RERANKER_ALIBABA_API_KEY = "VIVIDMEMORY_API_RERANKER_ALIBABA_API_KEY"
ENV_RERANKER_ALIBABA_MODEL = "VIVIDMEMORY_API_RERANKER_ALIBABA_MODEL"

# Google Discovery Engine reranker configuration
ENV_RERANKER_GOOGLE_MODEL = "VIVIDMEMORY_API_RERANKER_GOOGLE_MODEL"
ENV_RERANKER_GOOGLE_PROJECT_ID = "VIVIDMEMORY_API_RERANKER_GOOGLE_PROJECT_ID"
ENV_RERANKER_GOOGLE_SERVICE_ACCOUNT_KEY = "VIVIDMEMORY_API_RERANKER_GOOGLE_SERVICE_ACCOUNT_KEY"

ENV_VECTOR_EXTENSION = "VIVIDMEMORY_API_VECTOR_EXTENSION"
ENV_TEXT_SEARCH_EXTENSION = "VIVIDMEMORY_API_TEXT_SEARCH_EXTENSION"
ENV_TEXT_SEARCH_EXTENSION_NATIVE_LANGUAGE = "VIVIDMEMORY_API_TEXT_SEARCH_EXTENSION_NATIVE_LANGUAGE"
ENV_TEXT_SEARCH_EXTENSION_PG_SEARCH_TOKENIZER = "VIVIDMEMORY_API_TEXT_SEARCH_EXTENSION_PG_SEARCH_TOKENIZER"
ENV_LLM_OUTPUT_LANGUAGE = "VIVIDMEMORY_API_LLM_OUTPUT_LANGUAGE"
ENV_QUERY_ANALYZER_LANGUAGES = "VIVIDMEMORY_API_QUERY_ANALYZER_LANGUAGES"

ENV_HOST = "VIVIDMEMORY_API_HOST"
ENV_PORT = "VIVIDMEMORY_API_PORT"
ENV_BASE_PATH = "VIVIDMEMORY_API_BASE_PATH"
ENV_LOG_LEVEL = "VIVIDMEMORY_API_LOG_LEVEL"
ENV_LOG_FORMAT = "VIVIDMEMORY_API_LOG_FORMAT"
ENV_LOG_JSON_FIELDS = "VIVIDMEMORY_API_LOG_JSON_FIELDS"
ENV_WORKERS = "VIVIDMEMORY_API_WORKERS"
ENV_ACCESS_LOG = "VIVIDMEMORY_API_ACCESS_LOG"
ENV_MCP_ENABLED = "VIVIDMEMORY_API_MCP_ENABLED"
ENV_MCP_ENABLED_TOOLS = "VIVIDMEMORY_API_MCP_ENABLED_TOOLS"
ENV_MCP_STATELESS = "VIVIDMEMORY_API_MCP_STATELESS"
ENV_MCP_INSTRUCTIONS = "VIVIDMEMORY_API_MCP_INSTRUCTIONS"
ENV_ENABLE_BANK_CONFIG_API = "VIVIDMEMORY_API_ENABLE_BANK_CONFIG_API"
ENV_ENABLE_BANK_LLM_HEALTH = "VIVIDMEMORY_API_ENABLE_BANK_LLM_HEALTH"
ENV_ENABLE_DRY_RUN_EXTRACT = "VIVIDMEMORY_API_ENABLE_DRY_RUN_EXTRACT"
ENV_DEFAULT_BANK_TEMPLATE = "VIVIDMEMORY_API_DEFAULT_BANK_TEMPLATE"
ENV_GRAPH_RETRIEVER = "VIVIDMEMORY_API_GRAPH_RETRIEVER"
ENV_RECALL_MAX_CONCURRENT = "VIVIDMEMORY_API_RECALL_MAX_CONCURRENT"
ENV_RECALL_CONNECTION_BUDGET = "VIVIDMEMORY_API_RECALL_CONNECTION_BUDGET"
ENV_RECALL_MAX_QUERY_TOKENS = "VIVIDMEMORY_API_RECALL_MAX_QUERY_TOKENS"
ENV_MENTAL_MODEL_REFRESH_CONCURRENCY = "VIVIDMEMORY_API_MENTAL_MODEL_REFRESH_CONCURRENCY"
ENV_LINK_EXPANSION_PER_ENTITY_LIMIT = "VIVIDMEMORY_API_LINK_EXPANSION_PER_ENTITY_LIMIT"
ENV_LINK_EXPANSION_TIMEOUT = "VIVIDMEMORY_API_LINK_EXPANSION_TIMEOUT"
ENV_BANK_STATS_CACHE_TTL_SECONDS = "VIVIDMEMORY_API_BANK_STATS_CACHE_TTL_SECONDS"
ENV_BANK_STATS_CACHE_MAX_ENTRIES = "VIVIDMEMORY_API_BANK_STATS_CACHE_MAX_ENTRIES"

# OpenTelemetry tracing configuration
ENV_OTEL_TRACES_ENABLED = "VIVIDMEMORY_API_OTEL_TRACES_ENABLED"
ENV_OTEL_EXPORTER_OTLP_ENDPOINT = "VIVIDMEMORY_API_OTEL_EXPORTER_OTLP_ENDPOINT"
ENV_OTEL_EXPORTER_OTLP_HEADERS = "VIVIDMEMORY_API_OTEL_EXPORTER_OTLP_HEADERS"
ENV_OTEL_SERVICE_NAME = "VIVIDMEMORY_API_OTEL_SERVICE_NAME"
ENV_OTEL_DEPLOYMENT_ENVIRONMENT = "VIVIDMEMORY_API_OTEL_DEPLOYMENT_ENVIRONMENT"
ENV_METRICS_INCLUDE_BANK_ID = "VIVIDMEMORY_API_METRICS_INCLUDE_BANK_ID"
ENV_METRICS_BACKLOG_ENABLED = "VIVIDMEMORY_API_METRICS_BACKLOG_ENABLED"

# Runtime-stall observability (loop watchdog + DB pool acquire instrumentation)
ENV_LOOP_WATCHDOG_ENABLED = "VIVIDMEMORY_API_LOOP_WATCHDOG_ENABLED"
ENV_LOOP_WATCHDOG_STALL_THRESHOLD_MS = "VIVIDMEMORY_API_LOOP_WATCHDOG_STALL_THRESHOLD_MS"
ENV_LOOP_WATCHDOG_POLL_INTERVAL_MS = "VIVIDMEMORY_API_LOOP_WATCHDOG_POLL_INTERVAL_MS"
ENV_DB_ACQUIRE_WARN_THRESHOLD_MS = "VIVIDMEMORY_API_DB_ACQUIRE_WARN_THRESHOLD_MS"

# Vertex AI configuration
ENV_LLM_VERTEXAI_PROJECT_ID = "VIVIDMEMORY_API_LLM_VERTEXAI_PROJECT_ID"
ENV_LLM_VERTEXAI_REGION = "VIVIDMEMORY_API_LLM_VERTEXAI_REGION"
ENV_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY = "VIVIDMEMORY_API_LLM_VERTEXAI_SERVICE_ACCOUNT_KEY"

# Gemini safety settings
ENV_LLM_GEMINI_SAFETY_SETTINGS = "VIVIDMEMORY_API_LLM_GEMINI_SAFETY_SETTINGS"
...
ENV_LLM_PROMPT_CACHE_ENABLED = "VIVIDMEMORY_API_LLM_PROMPT_CACHE_ENABLED"
...
ENV_LLM_DEBUG_DUMP_4XX = "VIVIDMEMORY_API_LLM_DEBUG_DUMP_4XX"

# Retain settings
ENV_RETAIN_MAX_COMPLETION_TOKENS = "VIVIDMEMORY_API_RETAIN_MAX_COMPLETION_TOKENS"
ENV_RETAIN_CHUNK_SIZE = "VIVIDMEMORY_API_RETAIN_CHUNK_SIZE"
ENV_RETAIN_STRUCTURED_CHUNK_SIZE = "VIVIDMEMORY_API_RETAIN_STRUCTURED_CHUNK_SIZE"
ENV_RETAIN_EXTRACT_CAUSAL_LINKS = "VIVIDMEMORY_API_RETAIN_EXTRACT_CAUSAL_LINKS"
ENV_RETAIN_EXTRACTION_MODE = "VIVIDMEMORY_API_RETAIN_EXTRACTION_MODE"
ENV_RETAIN_MISSION = "VIVIDMEMORY_API_RETAIN_MISSION"
ENV_RETAIN_CUSTOM_INSTRUCTIONS = "VIVIDMEMORY_API_RETAIN_CUSTOM_INSTRUCTIONS"
ENV_RETAIN_DEFAULT_STRATEGY = "VIVIDMEMORY_API_RETAIN_DEFAULT_STRATEGY"
ENV_RETAIN_BATCH_TOKENS = "VIVIDMEMORY_API_RETAIN_BATCH_TOKENS"
ENV_RETAIN_ENTITY_LOOKUP = "VIVIDMEMORY_API_RETAIN_ENTITY_LOOKUP"
ENV_RETAIN_ENTITY_RESOLUTION_BATCH_SIZE = "VIVIDMEMORY_API_RETAIN_ENTITY_RESOLUTION_BATCH_SIZE"
ENV_RETAIN_BATCH_ENABLED = "VIVIDMEMORY_API_RETAIN_BATCH_ENABLED"
ENV_RETAIN_BATCH_POLL_INTERVAL_SECONDS = "VIVIDMEMORY_API_RETAIN_BATCH_POLL_INTERVAL_SECONDS"
ENV_RETAIN_CHUNK_BATCH_SIZE = "VIVIDMEMORY_API_RETAIN_CHUNK_BATCH_SIZE"

# File storage configuration
ENV_FILE_STORAGE_TYPE = "VIVIDMEMORY_API_FILE_STORAGE_TYPE"
ENV_FILE_STORAGE_S3_BUCKET = "VIVIDMEMORY_API_FILE_STORAGE_S3_BUCKET"
ENV_FILE_STORAGE_S3_REGION = "VIVIDMEMORY_API_FILE_STORAGE_S3_REGION"
ENV_FILE_STORAGE_S3_ENDPOINT = "VIVIDMEMORY_API_FILE_STORAGE_S3_ENDPOINT"
ENV_FILE_STORAGE_S3_ACCESS_KEY_ID = "VIVIDMEMORY_API_FILE_STORAGE_S3_ACCESS_KEY_ID"
ENV_FILE_STORAGE_S3_SECRET_ACCESS_KEY = "VIVIDMEMORY_API_FILE_STORAGE_S3_SECRET_ACCESS_KEY"
ENV_FILE_STORAGE_GCS_BUCKET = "VIVIDMEMORY_API_FILE_STORAGE_GCS_BUCKET"
ENV_FILE_STORAGE_GCS_SERVICE_ACCOUNT_KEY = "VIVIDMEMORY_API_FILE_STORAGE_GCS_SERVICE_ACCOUNT_KEY"
ENV_FILE_STORAGE_AZURE_CONTAINER = "VIVIDMEMORY_API_FILE_STORAGE_AZURE_CONTAINER"
ENV_FILE_STORAGE_AZURE_ACCOUNT_NAME = "VIVIDMEMORY_API_FILE_STORAGE_AZURE_ACCOUNT_NAME"
ENV_FILE_STORAGE_AZURE_ACCOUNT_KEY = "VIVIDMEMORY_API_FILE_STORAGE_AZURE_ACCOUNT_KEY"
ENV_FILE_PARSER = "VIVIDMEMORY_API_FILE_PARSER"
ENV_FILE_PARSER_ALLOWLIST = "VIVIDMEMORY_API_FILE_PARSER_ALLOWLIST"
ENV_FILE_PARSER_MARKITDOWN_OCR_ENABLED = "VIVIDMEMORY_API_FILE_PARSER_MARKITDOWN_OCR_ENABLED"
ENV_FILE_PARSER_MARKITDOWN_OCR_API_KEY = "VIVIDMEMORY_API_FILE_PARSER_MARKITDOWN_OCR_API_KEY"
ENV_FILE_PARSER_MARKITDOWN_OCR_BASE_URL = "VIVIDMEMORY_API_FILE_PARSER_MARKITDOWN_OCR_BASE_URL"
ENV_FILE_PARSER_MARKITDOWN_OCR_MODEL = "VIVIDMEMORY_API_FILE_PARSER_MARKITDOWN_OCR_MODEL"
ENV_FILE_PARSER_MARKITDOWN_OCR_PROMPT = "VIVIDMEMORY_API_FILE_PARSER_MARKITDOWN_OCR_PROMPT"
ENV_FILE_PARSER_MARKITDOWN_OCR_DEFAULT_HEADERS = "VIVIDMEMORY_API_FILE_PARSER_MARKITDOWN_OCR_DEFAULT_HEADERS"
ENV_FILE_PARSER_IRIS_TOKEN = "VIVIDMEMORY_API_FILE_PARSER_IRIS_TOKEN"
ENV_FILE_PARSER_IRIS_ORG_ID = "VIVIDMEMORY_API_FILE_PARSER_IRIS_ORG_ID"
ENV_FILE_PARSER_LLAMA_PARSE_API_KEY = "VIVIDMEMORY_API_FILE_PARSER_LLAMA_PARSE_API_KEY"
ENV_FILE_CONVERSION_MAX_BATCH_SIZE_MB = "VIVIDMEMORY_API_FILE_CONVERSION_MAX_BATCH_SIZE_MB"
ENV_FILE_CONVERSION_MAX_BATCH_SIZE = "VIVIDMEMORY_API_FILE_CONVERSION_MAX_BATCH_SIZE"
ENV_ENABLE_FILE_UPLOAD_API = "VIVIDMEMORY_API_ENABLE_FILE_UPLOAD_API"
ENV_FILE_DELETE_AFTER_RETAIN = "VIVIDMEMORY_API_FILE_DELETE_AFTER_RETAIN"
ENV_STORE_DOCUMENT_TEXT = "VIVIDMEMORY_API_STORE_DOCUMENT_TEXT"

# Document transfer (export/import documents between banks without re-running the LLM)
ENV_ENABLE_DOCUMENT_EXPORT_API = "VIVIDMEMORY_API_ENABLE_DOCUMENT_EXPORT_API"
ENV_ENABLE_DOCUMENT_IMPORT_API = "VIVIDMEMORY_API_ENABLE_DOCUMENT_IMPORT_API"

# Observations settings (consolidated knowledge from facts)
ENV_ENABLE_OBSERVATIONS = "VIVIDMEMORY_API_ENABLE_OBSERVATIONS"
ENV_ENABLE_AUTO_CONSOLIDATION = "VIVIDMEMORY_API_ENABLE_AUTO_CONSOLIDATION"
ENV_CONSOLIDATION_BATCH_SIZE = "VIVIDMEMORY_API_CONSOLIDATION_BATCH_SIZE"
ENV_CONSOLIDATION_MAX_MEMORIES_PER_ROUND = "VIVIDMEMORY_API_CONSOLIDATION_MAX_MEMORIES_PER_ROUND"
ENV_CONSOLIDATION_LLM_BATCH_SIZE = "VIVIDMEMORY_API_CONSOLIDATION_LLM_BATCH_SIZE"
ENV_CONSOLIDATION_DEDUP_THRESHOLD = "VIVIDMEMORY_API_CONSOLIDATION_DEDUP_THRESHOLD"
ENV_CONSOLIDATION_LLM_PARALLELISM = "VIVIDMEMORY_API_CONSOLIDATION_LLM_PARALLELISM"
ENV_CONSOLIDATION_MAX_TOKENS = "VIVIDMEMORY_API_CONSOLIDATION_MAX_TOKENS"
ENV_CONSOLIDATION_MAX_COMPLETION_TOKENS = "VIVIDMEMORY_API_CONSOLIDATION_MAX_COMPLETION_TOKENS"
ENV_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS = "VIVIDMEMORY_API_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS"
ENV_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS_PER_OBSERVATION = (
    "VIVIDMEMORY_API_CONSOLIDATION_SOURCE_FACTS_MAX_TOKENS_PER_OBSERVATION"
)
ENV_CONSOLIDATION_RECALL_BUDGET = "VIVIDMEMORY_API_CONSOLIDATION_RECALL_BUDGET"
ENV_CONSOLIDATION_MAX_ATTEMPTS = "VIVIDMEMORY_API_CONSOLIDATION_MAX_ATTEMPTS"
ENV_OBSERVATIONS_MISSION = "VIVIDMEMORY_API_OBSERVATIONS_MISSION"
ENV_MAX_OBSERVATIONS_PER_SCOPE = "VIVIDMEMORY_API_MAX_OBSERVATIONS_PER_SCOPE"
ENV_OBSERVATION_SCOPE_LIMITS = "VIVIDMEMORY_API_OBSERVATION_SCOPE_LIMITS"
ENV_ENABLE_OBSERVATION_HISTORY = "VIVIDMEMORY_API_ENABLE_OBSERVATION_HISTORY"
ENV_OBSERVATION_HISTORY_MAX_ENTRIES = "VIVIDMEMORY_API_OBSERVATION_HISTORY_MAX_ENTRIES"
ENV_ENABLE_MENTAL_MODEL_HISTORY = "VIVIDMEMORY_API_ENABLE_MENTAL_MODEL_HISTORY"
ENV_MENTAL_MODEL_HISTORY_MAX_ENTRIES = "VIVIDMEMORY_API_MENTAL_MODEL_HISTORY_MAX_ENTRIES"

# Webhook configuration (global, static - server-level only)
ENV_WEBHOOK_URL = "VIVIDMEMORY_API_WEBHOOK_URL"
ENV_WEBHOOK_SECRET = "VIVIDMEMORY_API_WEBHOOK_SECRET"
ENV_WEBHOOK_EVENT_TYPES = "VIVIDMEMORY_API_WEBHOOK_EVENT_TYPES"
ENV_WEBHOOK_DELIVERY_POLL_INTERVAL_SECONDS = "VIVIDMEMORY_API_WEBHOOK_DELIVERY_POLL_INTERVAL_SECONDS"

# Built-in llama.cpp configuration (for provider=llamacpp)
ENV_LLAMACPP_MODEL_PATH = "VIVIDMEMORY_API_LLAMACPP_MODEL_PATH"
ENV_LLAMACPP_GPU_LAYERS = "VIVIDMEMORY_API_LLAMACPP_GPU_LAYERS"
ENV_LLAMACPP_CONTEXT_SIZE = "VIVIDMEMORY_API_LLAMACPP_CONTEXT_SIZE"
ENV_LLAMACPP_CHAT_FORMAT = "VIVIDMEMORY_API_LLAMACPP_CHAT_FORMAT"
ENV_LLAMACPP_NO_GRAMMAR = "VIVIDMEMORY_API_LLAMACPP_NO_GRAMMAR"
ENV_LLAMACPP_EXTRA_ARGS = "VIVIDMEMORY_API_LLAMACPP_EXTRA_ARGS"

# Optimization flags
ENV_SKIP_LLM_VERIFICATION = "VIVIDMEMORY_API_SKIP_LLM_VERIFICATION"

# Database migrations
ENV_RUN_MIGRATIONS_ON_STARTUP = "VIVIDMEMORY_API_RUN_MIGRATIONS_ON_STARTUP"
ENV_MIGRATION_CONCURRENCY = "VIVIDMEMORY_API_MIGRATION_CONCURRENCY"

# Database connection pool
ENV_DB_POOL_MIN_SIZE = "VIVIDMEMORY_API_DB_POOL_MIN_SIZE"
ENV_DB_POOL_MAX_SIZE = "VIVIDMEMORY_API_DB_POOL_MAX_SIZE"
ENV_DB_COMMAND_TIMEOUT = "VIVIDMEMORY_API_DB_COMMAND_TIMEOUT"
ENV_DB_ACQUIRE_TIMEOUT = "VIVIDMEMORY_API_DB_ACQUIRE_TIMEOUT"
ENV_DB_STATEMENT_TIMEOUT = "VIVIDMEMORY_API_DB_STATEMENT_TIMEOUT"
ENV_DB_MAX_PARALLEL_WORKERS_PER_GATHER = "VIVIDMEMORY_API_DB_MAX_PARALLEL_WORKERS_PER_GATHER"
ENV_ENTITY_TRGM_SIMILARITY_THRESHOLD = "VIVIDMEMORY_API_ENTITY_TRGM_SIMILARITY_THRESHOLD"
...
ENV_MODEL_INIT_TIMEOUT = "VIVIDMEMORY_API_MODEL_INIT_TIMEOUT"

# Worker configuration (distributed task processing)
ENV_WORKER_ENABLED = "VIVIDMEMORY_API_WORKER_ENABLED"
ENV_WORKER_ID = "VIVIDMEMORY_API_WORKER_ID"
ENV_WORKER_POLL_INTERVAL_MS = "VIVIDMEMORY_API_WORKER_POLL_INTERVAL_MS"
ENV_WORKER_MAX_RETRIES = "VIVIDMEMORY_API_WORKER_MAX_RETRIES"
ENV_WORKER_TASK_RETRY_BACKOFF_SECONDS = "VIVIDMEMORY_API_WORKER_TASK_RETRY_BACKOFF_SECONDS"
ENV_WORKER_HTTP_PORT = "VIVIDMEMORY_API_WORKER_HTTP_PORT"
ENV_WORKER_MAX_SLOTS = "VIVIDMEMORY_API_WORKER_MAX_SLOTS"
ENV_OPERATION_RETENTION_DAYS = "VIVIDMEMORY_API_OPERATION_RETENTION_DAYS"
ENV_OPERATION_CLEANUP_BATCH_SIZE = "VIVIDMEMORY_API_OPERATION_CLEANUP_BATCH_SIZE"
...
def _parse_worker_slot_reservations() -> dict[str, int]:
    ...
    ``VIVIDMEMORY_API_WORKER_<TYPE>_MAX_SLOTS`` is a deprecated alias for
    ...
    for op_type, default in WORKER_SLOT_TYPE_DEFAULTS.items():
        reserved_env = f"VIVIDMEMORY_API_WORKER_{op_type.upper()}_RESERVED_SLOTS"
        legacy_env = f"VIVIDMEMORY_API_WORKER_{op_type.upper()}_MAX_SLOTS"
...
ENV_WORKER_CONSOLIDATION_BANK_PRIORITY = "VIVIDMEMORY_API_WORKER_CONSOLIDATION_BANK_PRIORITY"
ENV_RETAIN_MAX_CONCURRENT = "VIVIDMEMORY_API_RETAIN_MAX_CONCURRENT"
ENV_RETAIN_WALL_TIMEOUT = "VIVIDMEMORY_API_RETAIN_WALL_TIMEOUT"

# Reflect agent settings
ENV_REFLECT_MAX_ITERATIONS = "VIVIDMEMORY_API_REFLECT_MAX_ITERATIONS"
ENV_REFLECT_PROMPT_CACHE_ENABLED = "VIVIDMEMORY_API_REFLECT_PROMPT_CACHE_ENABLED"
ENV_REFLECT_MAX_CONTEXT_TOKENS = "VIVIDMEMORY_API_REFLECT_MAX_CONTEXT_TOKENS"
ENV_REFLECT_WALL_TIMEOUT = "VIVIDMEMORY_API_REFLECT_WALL_TIMEOUT"
ENV_REFLECT_MISSION = "VIVIDMEMORY_API_REFLECT_MISSION"
ENV_REFLECT_SOURCE_FACTS_MAX_TOKENS = "VIVIDMEMORY_API_REFLECT_SOURCE_FACTS_MAX_TOKENS"
ENV_RECALL_INCLUDE_CHUNKS = "VIVIDMEMORY_API_RECALL_INCLUDE_CHUNKS"
ENV_RECALL_MAX_TOKENS = "VIVIDMEMORY_API_RECALL_MAX_TOKENS"
ENV_RECALL_CHUNKS_MAX_TOKENS = "VIVIDMEMORY_API_RECALL_CHUNKS_MAX_TOKENS"

# Recall budget mapping (budget enum -> thinking_budget integer)
ENV_RECALL_BUDGET_FUNCTION = "VIVIDMEMORY_API_RECALL_BUDGET_FUNCTION"
ENV_RECALL_BUDGET_FIXED_LOW = "VIVIDMEMORY_API_RECALL_BUDGET_FIXED_LOW"
ENV_RECALL_BUDGET_FIXED_MID = "VIVIDMEMORY_API_RECALL_BUDGET_FIXED_MID"
ENV_RECALL_BUDGET_FIXED_HIGH = "VIVIDMEMORY_API_RECALL_BUDGET_FIXED_HIGH"
ENV_RECALL_BUDGET_ADAPTIVE_LOW = "VIVIDMEMORY_API_RECALL_BUDGET_ADAPTIVE_LOW"
ENV_RECALL_BUDGET_ADAPTIVE_MID = "VIVIDMEMORY_API_RECALL_BUDGET_ADAPTIVE_MID"
ENV_RECALL_BUDGET_ADAPTIVE_HIGH = "VIVIDMEMORY_API_RECALL_BUDGET_ADAPTIVE_HIGH"
ENV_RECALL_BUDGET_MIN = "VIVIDMEMORY_API_RECALL_BUDGET_MIN"
ENV_RECALL_BUDGET_MAX = "VIVIDMEMORY_API_RECALL_BUDGET_MAX"

# Recall candidate gating (per-source cap + BM25 score floor)
ENV_BM25_MIN_SCORE = "VIVIDMEMORY_API_BM25_MIN_SCORE"
ENV_BM25_MAX_QUERY_TERMS = "VIVIDMEMORY_API_BM25_MAX_QUERY_TERMS"
ENV_RECALL_MAX_CANDIDATES_PER_SOURCE = "VIVIDMEMORY_API_RECALL_MAX_CANDIDATES_PER_SOURCE"
...
ENV_RECALL_STRATEGY_BOOSTS = "VIVIDMEMORY_API_RECALL_STRATEGY_BOOSTS"
...
ENV_RECENCY_DECAY_FUNCTION = "VIVIDMEMORY_API_RECENCY_DECAY_FUNCTION"
ENV_RECENCY_DECAY_LINEAR_WINDOW_DAYS = "VIVIDMEMORY_API_RECENCY_DECAY_LINEAR_WINDOW_DAYS"
ENV_RECENCY_DECAY_HALFLIFE_DAYS = "VIVIDMEMORY_API_RECENCY_DECAY_HALFLIFE_DAYS"
...
ENV_AUDIT_LOG_ENABLED = "VIVIDMEMORY_API_AUDIT_LOG_ENABLED"
ENV_AUDIT_LOG_ACTIONS = "VIVIDMEMORY_API_AUDIT_LOG_ACTIONS"
ENV_AUDIT_LOG_RETENTION_DAYS = "VIVIDMEMORY_API_AUDIT_LOG_RETENTION_DAYS"

# Retain reliability settings
ENV_FAIL_ON_EXTRACTION_ERRORS = "VIVIDMEMORY_API_FAIL_ON_EXTRACTION_ERRORS"

# LLM request tracing settings
ENV_LLM_TRACE_ENABLED = "VIVIDMEMORY_API_LLM_TRACE_ENABLED"
ENV_LLM_TRACE_SCOPES = "VIVIDMEMORY_API_LLM_TRACE_SCOPES"
ENV_LLM_TRACE_RETENTION_DAYS = "VIVIDMEMORY_API_LLM_TRACE_RETENTION_DAYS"
ENV_LLM_TRACE_MAX_CHARS = "VIVIDMEMORY_API_LLM_TRACE_MAX_CHARS"

# Background maintenance settings
ENV_CONSOLIDATION_RECONCILE_INTERVAL_SECONDS = "VIVIDMEMORY_API_CONSOLIDATION_RECONCILE_INTERVAL_SECONDS"
ENV_MENTAL_MODEL_REFRESH_TICK_SECONDS = "VIVIDMEMORY_API_MENTAL_MODEL_REFRESH_TICK_SECONDS"

# Disposition settings
ENV_DISPOSITION_SKEPTICISM = "VIVIDMEMORY_API_DISPOSITION_SKEPTICISM"
ENV_DISPOSITION_LITERALISM = "VIVIDMEMORY_API_DISPOSITION_LITERALISM"
ENV_DISPOSITION_EMPATHY = "VIVIDMEMORY_API_DISPOSITION_EMPATHY"
...
# ZeroEntropy's API default is 2560, but VividMemory defaults to 1280 so the
...
# default; set VIVIDMEMORY_API_ENABLE_DRY_RUN_EXTRACT=false to remove the endpoint (e.g. to cap
...
# requires the global prompt cache (VIVIDMEMORY_API_LLM_PROMPT_CACHE_ENABLED) to also
...
DEFAULT_OTEL_SERVICE_NAME = "vividmemory-api"
...
def validate_retain_chunking_config(
    ...
    *,
    ...
    don't have to override them. The startup validator (VividMemoryConfig.validate)
    overrides to env-style names ("VIVIDMEMORY_API_RETAIN_CHUNK_SIZE") for env
    misconfig errors.
    """
...
class LLMMemberConfig:
    ...
    (``VIVIDMEMORY_API_<OP>LLM_<n>_*``). The unindexed config remains the primary
...
def _parse_llm_members(prefix: str) -> list[LLMMemberConfig]:
    ...
    ``VIVIDMEMORY_API_{prefix}LLM_{n}_PROVIDER`` for n = 1, 2, ... and scanning
    ...
    index = 1
    while True:
        base = f"VIVIDMEMORY_API_{prefix}LLM_{index}_"
...
class RerankerMemberConfig:
    ...
    Member 0 is the **primary**: the unindexed ``VIVIDMEMORY_API_RERANKER_*``
    settings, built by :meth:`VividMemoryConfig.reranker_chain`. Members 1..N come
    from ``VIVIDMEMORY_API_RERANKER_<n>_*`` and are read in isolation — an indexed
    member inherits nothing from the primary and nothing from the shared provider
    keys (``VIVIDMEMORY_API_COHERE_API_KEY`` and friends), so every setting it needs
    must be spelled out with its own index. Settings left unset fall back to the
    same built-in defaults the primary uses.

    The fields mirror the ``reranker_*`` fields of :class:`VividMemoryConfig`, minus
    ...
    def env_name(self, suffix: str) -> str:
        ...
        ``"TEI_URL"`` → ``VIVIDMEMORY_API_RERANKER_TEI_URL`` for the primary and
        ``VIVIDMEMORY_API_RERANKER_1_TEI_URL`` for member 1.
        """
        infix = "" if self.index == 0 else f"{self.index}_"
        return f"VIVIDMEMORY_API_RERANKER_{infix}{suffix}"
...
def _parse_reranker_members() -> list[RerankerMemberConfig]:
    ...
    Members are read from ``VIVIDMEMORY_API_RERANKER_{n}_PROVIDER`` for n = 1, 2, ...
    ...
    index = 1
    while True:
        base = f"VIVIDMEMORY_API_RERANKER_{index}_"
        provider = os.getenv(base + "PROVIDER")
        if not provider:
            break
        members.append(
...
def _parse_default_bank_template(raw: str | None) -> dict | None:
    """
    Parse VIVIDMEMORY_API_DEFAULT_BANK_TEMPLATE as JSON.
...
@dataclass
class VividMemoryConfig:
    """Configuration container for VividMemory API."""
    ...
    llm_default_headers: (
        dict | None
    )  # Custom headers passed as default_headers to provider SDK clients (e.g. {"X-Component-Id": "vividmemory"} for proxies / request tracing)
    ...
    # model/server default instead of forcing a VividMemory-wide value.
    ...
    # reranker config above; these are the extra VIVIDMEMORY_API_RERANKER_<n>_*
    ...
    def reranker_chain(self) -> list[RerankerMemberConfig]:
        ...
        shared-key fallbacks (``VIVIDMEMORY_API_COHERE_API_KEY``,
        ``VIVIDMEMORY_API_LLM_VERTEXAI_PROJECT_ID``, ...). Indexed members do not —
        ...
        primary = RerankerMemberConfig(
            ...
            # flashrank has no VividMemoryConfig fields — it is read from the env directly
    ...
    def validate(self) -> None:
        ...
        if self.llm_bedrock_service_tier not in valid_bedrock_tiers:
            raise ValueError(
                f"Invalid VIVIDMEMORY_API_LLM_BEDROCK_SERVICE_TIER: "
        ...
        validate_retain_chunking_config(
            ...
            retain_chunk_size_name="VIVIDMEMORY_API_RETAIN_CHUNK_SIZE",
            retain_structured_chunk_size_name="VIVIDMEMORY_API_RETAIN_STRUCTURED_CHUNK_SIZE",
        )
        ...
        validate_retain_completion_token_budget(
            ...
            retain_max_completion_tokens_name="VIVIDMEMORY_API_RETAIN_MAX_COMPLETION_TOKENS",
            retain_chunk_size_name="VIVIDMEMORY_API_RETAIN_CHUNK_SIZE",
        )
        ...
        if self.embeddings_provider == "local" or self.reranker_provider == "local":
            try:
                ...
                logger.warning(
                    ...
                    "  1. Install local ML deps: pip install vividmemory-api[local-ml]\n"
                    "  2. Use a remote provider instead:\n"
                    "     VIVIDMEMORY_API_EMBEDDINGS_PROVIDER=openai (or gemini, tei)\n"
                    "     VIVIDMEMORY_API_RERANKER_PROVIDER=none (or tei)",
                    " and ".join(missing),
                )
        ...
        if self.embeddings_provider == "onnx":
            try:
                ...
                logger.warning(
                    ...
                    "  1. Install ONNX deps: pip install vividmemory-api-slim[local-onnx]\n"
                    "  2. Use a different embeddings provider, e.g. VIVIDMEMORY_API_EMBEDDINGS_PROVIDER=local "
                    "or openai"
                )
        ...
        if total_reserved > self.worker_max_slots:
            ...
            raise ValueError(
                ...
                f"Reduce reservations or increase VIVIDMEMORY_API_WORKER_MAX_SLOTS."
            )
    ...
    @classmethod
    def from_env(cls) -> "VividMemoryConfig":
...
_config_cache: VividMemoryConfig | None = None
...
def _get_raw_config() -> VividMemoryConfig:
    """
    ...
    if _config_cache is None:
        _config_cache = VividMemoryConfig.from_env()
