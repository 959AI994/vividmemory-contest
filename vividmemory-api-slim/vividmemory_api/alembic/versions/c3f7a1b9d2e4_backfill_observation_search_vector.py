...
The configured ``VIVIDMEMORY_API_TEXT_SEARCH_EXTENSION_NATIVE_LANGUAGE`` is used
...
``VividMemoryConfig.validate``) before being embedded as a SQL literal.
...
# Matches VividMemoryConfig.validate(): a tsvector regconfig name embedded as a
