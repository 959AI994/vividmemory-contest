...
from vividmemory_api._pg_search import (
    PG_SEARCH_TOKENIZER_ENV,
    normalize_pg_search_tokenizer,
    pg_search_bm25_columns,
)
from vividmemory_api.alembic._dialect import run_for_dialect
...
def _detect_vector_extension() -> str:
    ...
    Respects VIVIDMEMORY_API_VECTOR_EXTENSION env var if set.
    """
    conn = op.get_bind()
    vector_extension = os.getenv("VIVIDMEMORY_API_VECTOR_EXTENSION", "pgvector").lower()
    ...
    if vector_extension == "pgvector":
        ...
        return "pgvector"
    raise ValueError(
        "Invalid VIVIDMEMORY_API_VECTOR_EXTENSION: "
...
def _detect_text_search_extension() -> str:
    ...
    'pgroonga', or 'pg_search'. Respects VIVIDMEMORY_API_TEXT_SEARCH_EXTENSION env var.
    ...
    """
    text_search_extension = os.getenv("VIVIDMEMORY_API_TEXT_SEARCH_EXTENSION", "native").lower()
    ...
    if text_search_extension == "vchord":
        ...
        raise ValueError(
            f"Invalid VIVIDMEMORY_API_TEXT_SEARCH_EXTENSION: {text_search_extension}. "
