"""Shared MCP tool implementations for VividMemory.
...
from vividmemory_api.engine.audit import AuditEntry, AuditLogger
from vividmemory_api.engine.memory_engine import Budget
from vividmemory_api.engine.response_models import VALID_RECALL_FACT_TYPES, MinScores
...
# MCP tool annotations. VividMemory is a closed memory store (no open-world / internet
